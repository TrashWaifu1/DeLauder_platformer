...
public class enemyController : MonoBehaviour
{
    ...
    {
        // If enemy is hit by bullet, apply a knockback force from the bullet amplified by the desired knockbackModifier value and take off one health unit each hit
        if(collision.gameObject.name.Contains("bullet"))
        {
            myRB.AddForce(collision.relativeVelocity * knockbackModifier);
            health--;
        }
    }
}                    
